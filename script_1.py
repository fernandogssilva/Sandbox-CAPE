...
# Criar segunda parte do script (após o primeiro reboot)

cape_install_script_part2 = """#!/bin/bash
...
with open('cape_install_part2.sh', 'w') as f:
    f.write(cape_install_script_part2)

print("Script parte 2 criado: cape_install_part2.sh")
print("="*70)
