...
# Criar script de configuração dos arquivos do CAPE

cape_config_script = """#!/bin/bash
...
with open('cape_config.sh', 'w') as f:
    f.write(cape_config_script)

print("Script de configuração criado: cape_config.sh")
print("="*70)
